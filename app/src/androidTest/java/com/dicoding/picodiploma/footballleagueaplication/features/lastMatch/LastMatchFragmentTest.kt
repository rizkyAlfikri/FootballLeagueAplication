...
class LastMatchFragmentTest {
    ...
    @Test
    @OkReplay(tape = "instrumental_test_last_match_league_and_add_to_favorite", mode = TapeMode.READ_ONLY)
    fun test_last_match_league_and_add_to_favorite() {
        ...
        // last match
        Espresso.onView(ViewMatchers.withText("Last Match"))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed())).perform(ViewActions.click())
        Espresso.onView(ViewMatchers.withId(R.id.rv_last_match))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        Espresso.onView(ViewMatchers.withId(R.id.rv_last_match)).perform(
        ...
        // move to detail last match and add match to favorite list
